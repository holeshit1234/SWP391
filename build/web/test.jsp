...
updateButtons.forEach(button => {
  button.addEventListener('click', event => {
    ...
    const email = row.querySelector('input[name="txtUser"]').value;
    const fullname = row.querySelector('input[name="txtUser"]').value;
                                        ...
                                        <tbody>
                                            <c:forEach var="dto" items="${user_info}">
                                                ...
                                                <tr>     
                                                    ...
                                                    <td>                               
                                                        <input type="submit" value="Update" name="btAction" class="update-button"/>
                                                        <input type="submit" value="BanUser" name="btAction" />
                                                        <input type="submit" value="UnBanUser" name="btAction" />
                                                    </td>
