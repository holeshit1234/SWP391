        ...
        try {
            ...
            if (isError) {
                ...
                if (!emailExist && !usernameExist) {
                    ...
                    UserDetailsDTO userAccount = new UserDetailsDTO(role, role, username, password, email, fullname, phone, dob, gender, "23b33efd6739a27e12124c02169572c0.jpg");
                    //process - add into database
                    int key = 0;
                    key = dao.addUser(userAccount);
                    if (key > 0) {
                        AddressDAO dao2 = new AddressDAO();
                        AddressDTO address = new AddressDTO(0, key, province, ward, street, province, district, true);
