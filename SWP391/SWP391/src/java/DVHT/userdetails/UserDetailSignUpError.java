...
public class UserDetailSignUpError implements Serializable {
    ...
    public UserDetailSignUpError() {
    }

    public UserDetailSignUpError(String usernameLengthErr, String passwordLengthErr, String confirmNotMatchErr, String fullnameLengthErr, String emailErr, int phone) {
