 ...
 * @author User
 */
@WebServlet(name = "ShowAddressServlet", urlPatterns = {"/ShowAddressServlet"})
public class ShowAddressServlet extends HttpServlet {
    
    
    
    private final String  ADDRESSPAGE = "showAddress.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            log("ShowAddressServlet_Naming " + ex.getMessage());
        } catch (SQLException ex) {
            log("ShowAddressServlet_SQL " + ex.getMessage());
        }finally{
