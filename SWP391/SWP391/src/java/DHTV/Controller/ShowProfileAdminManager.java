 ...
 * @author User
 */
@WebServlet(name = "ShowProfileAdminManager", urlPatterns = {"/ShowProfileAdminManager"})
public class ShowProfileAdminManager extends HttpServlet {

     private final String PROFILE_PAGE = "profileAdminManager.jsp";
    /**
            ...
            if (session != null) {
                ...
                if (dto != null) {
                    ...
                    if (result != null) {
                        ...
                        session.setAttribute("INFO", result1);
