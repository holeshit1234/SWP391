                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <c:if test="${not empty result}">  
                                        ...
                                        <table border="1">
                                            ...
                                            <tbody>
                                                <c:forEach var="dto" items="${daoProductDetail.getDetailList()}">
                                                    <tr>
                                                        <td>${daoSize.getNameSizeBySizeID(dto.getSizeID()).getSizeName()}
                                                            <input type="hidden" name ="sizeID" value="${dto.getSizeID()}"/>
                                                        </td>
                                                        <td> <input type="text" name ="NewQuantity" value="${dto.getQuantity()}"></td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
                                ...
                                <!--                                <a href="ShowAllListProductServlet" class="back-button">Back</a>-->
