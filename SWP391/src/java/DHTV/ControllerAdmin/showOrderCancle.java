 ...
 * @author mthin
 */
@WebServlet(name = "showOrderCancle", urlPatterns = {"/showOrderCancle"})
public class showOrderCancle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "showOrderCanclePage.jsp";
            ...
            if (session != null) {
                ...
                if (dto1 != null) {
                    if (dto1.getRoleID() == 1 || dto1.getRoleID() == 2) {
                        ...
                        request.setAttribute("CANCLE_RESULT", list);
                    }
                }
           }else{
            url = "erorr.jsp";
