 ...
 * @author User
 */
@WebServlet(name = "ShowUserByManagerServlet", urlPatterns = {"/ShowUserByManagerServlet"})
public class ShowUserByManagerServlet extends HttpServlet {
