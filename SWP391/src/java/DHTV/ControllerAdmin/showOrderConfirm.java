 ...
 * @author mthin
 */
@WebServlet(name = "showOrderConfirm", urlPatterns = {"/showOrderConfirm"})
public class showOrderConfirm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "showOrderConfirmPage.jsp";
        ...
        try {
            ...
            log("ShowOrder _ Naming _ " + ex.getMessage());
        } catch (SQLException ex) {
            log("ShowOrder _ SQL _ " + ex.getMessage());
        } finally {
