 ...
 * @author mthin
 */
@WebServlet(name = "showSizeServlet", urlPatterns = {"/showSizeServlet"})
public class showSizeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "showSizePage.jsp";
        try {
            SizeDAO dao = new SizeDAO();

            dao.showSizeList();
            List<SizeDTO> list = dao.getSizeList();
            request.setAttribute("SIZE_RESULT", list);
