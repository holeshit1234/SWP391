...
public class UpdatePaymentServlet extends HttpServlet {
    ...
    private final String UPDATE_SUCCESS = "GetPaymentMethodServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String avai = request.getParameter("available");
        ...
        try {
                ...
                if (dto1 != null) {
                    if (dto1.getRoleID() == 1 || dto1.getRoleID() == 2) {
                        if (button.equals("update")) {
                            ...
                            if (avai.equals("false")) {
                                available = true;
                            } else {
                                available = false;
                            }

                            boolean result = dao.updatePayment(paymentID, available);
            ...
            log("UpdatePaymentServlet Naming: " + ex.getMessage());
        } finally {
